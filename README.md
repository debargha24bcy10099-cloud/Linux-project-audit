...
TOpen Source Software (OSS NGMC) Capstone Project – VIT
Conducted a comprehensive audit of the Linux Kernel, analyzing its history, GPL v2 licensing, ethical framework, and technical footprint within the FOSS ecosystem. Accompanied the research with five practical Bash scripts demonstrating applied command-line skills, including file handling, loop and conditional logic, and user input processing.
...
│
├── report/
│   └── OSS_Audit_Report_Debargha Saha_24BCY10099.pdf
│
└── screenshots/
...
git clone https://github.com/[yourusername]/oss-audit-24BCY10099.git
cd oss-audit-24BCY10099
